...
test('turn numbers into strings', () => {
  const numbers = { 'Grace Hopper': '222-303-5938', 'Ada Lovelace': '222-349-9842', 'Alan Turing': '222-853-5933' };
...
test('boolean has children or not', () => {
  const characters = [
    {
      name: 'Eddard',
      spouse: 'Catelyn',
